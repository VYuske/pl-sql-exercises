...
Crie um bloco PL/SQL anônimo que calcule um incentivo financeiro para o beneficiário de ID = 110.
O incentivo deve ser de 10% do custo total de todos os procedimentos realizados por ele no último ano.

Entrada: ID do beneficiário (fixo = 110)
Saída: Exibir o valor total do incentivo com DBMS_OUTPUT.PUT_LINE.
...
## 04 Aspas Duplas em Identificadores

Crie um bloco PL/SQL que declare uma variável com o nome "Status", atribua um valor e mostre o resultado ignorando ou não as aspas.
Demonstre que o uso incorreto de maiúsculas e minúsculas afeta o reconhecimento.

Saída esperada: Impressão correta apenas quando o identificador é usado conforme declarado.

## 05 Case Sensitivity em Identificadores
...
## 06 Comentários de Linha e Bloco
...
## 10 Atualização de Dados (Salário → Custo)
...
## 12 Operador IS [NOT] NULL com AND
...
## 13 Operador IS [NOT] NULL com OR
